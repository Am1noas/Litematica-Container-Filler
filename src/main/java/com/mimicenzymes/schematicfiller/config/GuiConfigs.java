...
import com.mimicenzymes.schematicfiller.SchematicfillerClient;
...
public class GuiConfigs extends GuiConfigsBase {
    ...
    public GuiConfigs(Screen parent) {
        super(10, 50, SchematicfillerClient.MOD_ID, parent, "schematic_container_filler.gui.title.configs");
    }
