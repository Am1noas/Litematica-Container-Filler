package com.mimicenzymes.schematicfiller;

import com.mimicenzymes.schematicfiller.config.ConfigHandler;
import com.mimicenzymes.schematicfiller.config.Configs;
import com.mimicenzymes.schematicfiller.config.GuiConfigs;
import com.mimicenzymes.schematicfiller.core.AreaScanner;
import com.mimicenzymes.schematicfiller.core.AutoFillerStateMachine;
import com.mimicenzymes.schematicfiller.core.ContainerHighlighter;
import com.mimicenzymes.schematicfiller.core.SchematicChangeListener;
import com.mimicenzymes.schematicfiller.core.RealContainerCache;
import com.mimicenzymes.schematicfiller.input.InputHandler;
...
public class SchematicfillerClient implements ClientModInitializer {
    public static final String MOD_ID = "schematic_container_filler";
    ...
    public void onInitializeClient() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (!com.mimicenzymes.schematicfiller.config.Configs.ENABLE_MOD.getBooleanValue()) {
                return;
            }
                        ...
                        if (Configs.AREA_MODE.getBooleanValue()) {
                            ...
                            if (client.crosshairTarget != null && client.crosshairTarget.getType() == HitResult.Type.BLOCK) {
                                ...
                                if (!CROSSHAIR_COOLDOWNS.containsKey(pos) || now - CROSSHAIR_COOLDOWNS.get(pos) >= 5000) {
                                    Map<Integer, ItemStack> required = com.mimicenzymes.schematicfiller.core.SchematicContainerReader.getRequiredItems(pos, client.world.getRegistryManager());
    ...
    private static class InitHandler implements IInitializationHandler {
        ...
        public void registerModHandlers() {
            ...
            configHandler.load();
            ConfigManager.getInstance().registerConfigHandler(SchematicfillerClient.MOD_ID, configHandler);
